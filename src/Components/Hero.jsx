      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6 z-10">
          ...
          <p className="text-lg text-gray-600 max-w-lg">
            Maximize your tax refund with ComplianceBro. File your ITR in under 4 minutes with our AI-powered engine or hire a Personal CA.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-xl transition transform hover:-translate-y-1">
              File ITR Now
            </button>
            <button className="bg-white border-2 border-emerald-600 text-emerald-600 hover:bg-emerald-50 px-8 py-4 rounded-xl font-bold text-lg">
              Book a Tax Expert
            </button>
          </div>
        ...
        <div className="relative z-10">
          <img src="https://placehold.co/600x500/e6fffa/059669?text=ComplianceBro+App+Dashboard" alt="Compliance dashboard" className="w-full h-auto rounded-3xl shadow-2xl" />
